...
const Navbar = () => {
  ...
  useEffect(() => {
    const save:string=darkMode.toString();
  ...
  >
    {darkMode ? 'Light Mode' : 'Dark Mode'}
              ...
              <div className="relative ml-3" onClick={Error}>
                <div>
                  
                  <button
                    type="button"
                    className="relative flex rounded-full dark:bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
                    id="user-menu-button"
                    aria-expanded="false"
                    aria-haspopup="true"
                  >
